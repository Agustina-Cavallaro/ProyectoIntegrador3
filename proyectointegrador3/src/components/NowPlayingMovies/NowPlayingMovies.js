...
class NowPlayingMovies extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            filter: props.filter, //me dice si filtro los primeros 4 o no --> si es true solo los primeros 4 y oculta el cagrar mas 
    ...
    render(){
        ...
        let tieneBusqueda = this.state.valorFormulario !== ""; ///si el input esta vacio es false
